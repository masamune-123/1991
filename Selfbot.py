...
cl = LINETCR.LINE()
cl.login(token="EnpsItV0Vje5nekuxbZa.apGNZMzba418M2CeQxD9/G.ytxAADAsxlyHngOxxbpkH9YMnNOPETkBHswrn8801fI=")
cl.loginResult()

ki1 = LINETCR.LINE() #ได้
ki1.login(token="")
ki1.loginResult()

ki2 = LINETCR.LINE() #ได้
ki2.login(token="")
ki2.loginResult()

ki3 = LINETCR.LINE() #ได้
ki3.login(token="")
ki3.loginResult()

ki4 = LINETCR.LINE() #ได้
ki4.login(token="")
ki4.loginResult()

ki5 = LINETCR.LINE() #ได้
ki5.login(token="")
ki5.loginResult()

ki6 = LINETCR.LINE() #ได้
ki6.login(token="")
ki6.loginResult()

ki7 = LINETCR.LINE() #ได้
ki7.login(token="")
ki7.loginResult()

ki8 = LINETCR.LINE() #ได้
ki8.login(token="")
ki8.loginResult()

ki9 = LINETCR.LINE() #ได้
ki9.login(token="")
ki9.loginResult()

ki10 = LINETCR.LINE() #ได้
ki10.login(token="")
ki10.loginResult()
